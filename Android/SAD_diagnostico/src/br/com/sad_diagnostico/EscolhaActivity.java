...
import br.com.sad_diagnostico.R.id;
...
public class EscolhaActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		pergunta = (TextView) findViewById(R.id.t_pergunta);
		...
		pergunta.setText("Apresenta este sinal ou sintoma:\n" + sint_proximo
				+ "?");
		...
		numsit.setText("Numero de Doenças com esse Sintoma:" + num_doencas);
		botao_proximo();
		...
		b_proximo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (rd_escolhido.getId() != 0) {
					...
					if (Integer.parseInt(num_doencas) <= 1) {
					...
					Log.i("" + id_proximo + "-" + sint_proximo, "ID_PROXIMOS");
	...
	public String[] proximo_sintom(ArrayList<String> proximo,
		...
		Log.e("Metodo" + resultado, "MEtodo Resultado");
